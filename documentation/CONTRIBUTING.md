...
- Create a `your_feature.objc` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.objc",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.objc"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.objc"
        }
    },
    "name": "support.other.attribute.objc",
    "patterns": [
        {
